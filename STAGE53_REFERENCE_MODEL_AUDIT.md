...
| Persistent peat rate | Seoyeongari Clymo-model long-term lower/central/upper estimates 0.29/0.38/0.47 mm yr-1; model reference = central estimate 0.38 mm yr-1 | Site-derived from the field report; not selected by pond-area fit; not three independent replicates | STRONG PARAMETER PROVENANCE / ELEVATION-PROXY CAVEAT | Keep field-derived central estimate as central value; distinguish preserved peat accumulation from direct surface-elevation measurement |
...
At the Stage51 field-derived central peat rate 0.38 mm yr-1:
...
The central peat rate itself is not a pond-area calibration parameter: the field report gives 0.29/0.38/0.47 mm yr-1 as lower/central/upper long-term Clymo-model estimates, and 0.38 mm yr-1 is used as the field-derived central estimate. The remaining issue is physical interpretation. These age-depth/preserved peat accumulation estimates must not be called directly measured annual surface-elevation changes. The model can use the field-derived central estimate as a persistent-net biogeomorphic proxy, but that distinction must be explicit.
